...
const AboutHome = () => {
    return (
        <div className='relative max-w-300 mx-auto bg-white p-[80px_0px] flex flex-col items-center justify-center gap-5'>
            <h2 className='text-[#2a2a2a] font-medium text-[46px]'>About <span className='text-[#EA4434]'>Neurova Neurals</span></h2>
            <p className='text-[#2a2a2a] text-[16px] w-full text-center'>Neurova Neurals Private Limited is an innovation-driven EdTech organization with over 25
